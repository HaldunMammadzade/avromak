    ...
    <>
      {/* <ul className="d-flex align-items-center lang-link mb-0">
        <li
          ...
          className={
            language == "az" ? "color-black  px-2 cursor" : " px-2 cursor"
          }
        >
          <input
            className="mr-2"
        ...
        <li
          className={
            language == "en" ? "color-black  px-2 cursor" : " px-2 cursor"
          }
        >
          <input
            className="mr-2"
        ...
        <li
          className={
            language == "ru"
              ? "color-black  px-2 cursor d-flex aling-items-center"
              : " px-2 cursor d-flex aling-items-center"
          }
        >
          <input
            className="mr-2"
